...
const HasilTryout = () => {
  ...
  const { totalCorrect, totalWrong, totalEmpty, score, tryoutId } = location.state || { 
    totalCorrect: 0, 
    totalWrong: 0, 
    totalEmpty: 0, 
    score: 0, 
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden mb-10">
          ...
          <div className="p-8 pb-10 text-center">
            <h2 className="text-xl font-bold text-[#74151e] mb-2">
              Kamu Telah Menyelesaikan Tryout
            </h2>
            <p className="text-xs text-gray-500 mb-8 leading-relaxed px-4">
              Tryout berhasil kamu tuntaskan. Tetap semangat belajar dan tingkatkan terus kemampuanmu.
            </p>
            <div className="bg-[#F8F8F8] border border-gray-200 rounded-xl p-6 mb-8">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[11px] font-semibold text-gray-500">Jawaban Benar</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[11px] font-semibold text-gray-500">Jawaban Salah</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[11px] font-semibold text-gray-500">Tidak Terjawab</span>
                </div>
              </div>
            </div>
            <div className="flex gap-4">
              <button 
                ...
                onClick={() => navigate(`/pembahasan-tryout/${tryoutId}`)}
              >
                Lihat Pembahasan
              </button>
              <button 
