...
// import api from '../../api'; // <-- UNCOMMENT SAAT INTEGRASI BACKEND
...
export default function DashboardSiswa() {
    ...
    const initialCourses = [
        { id: 1, title: "Intensif UTBK: Matematika Saintek", mentor: "Kak Bimo", schedule: "Senin & Kamis, 14:00", image: "/assets/course-math.jpg" },
        { id: 2, title: "Mastering Tenses English", mentor: "Ms. Sarah", schedule: "Selasa, 16:00", image: "/assets/course-english.jpg" },
        { id: 3, title: "Fisika Dasar: Hukum Newton", mentor: "Kak Rio", schedule: "Rabu, 19:00", image: "/assets/course-physics.jpg" },
        { id: 4, title: "Kimia Organik Dasar", mentor: "Kak Andi", schedule: "Jumat, 13:00", image: "/assets/course-chem.jpg" },
    ];
            ...
            <main className="container mx-auto px-6 pt-24">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    <div className="lg:w-2/3">
                        ...
                        {loading ? (
                            <div className="text-center py-10"><p>Mencari kelas...</p></div>
                        ) : (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {courses.map(course => (
                                    <ClassCard 
                                        key={course.id} 
                                        id={course.id} // Passing ID agar bisa dipakai di URL
                                        {...course} 
                                    />
                                ))}
                            </div>
                        ...
                        {courses.length === 0 && !loading && (
                            <div className="text-center py-10 text-gray-500">Kelas tidak ditemukan.</div>
                        )}
                    </div>
